		...
		<section>
			<div className="max-w-6xl mx-auto px-4 sm:px-6">
				<div className="py-12 md:py-20">
					...
					{/* Section header */}
					<div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
						<h2 className="h2 mb-4">What is the plant calibration tool?</h2>
						<p className="text-xl text-gray-400">
							Exergenics web-based software, tailored to help user capture their
							plant and equipment configuration and metadata.
						</p>
					</div>
					{/* Items */}
					<div
					...
					>
						...
						>
							...
							<h4 className="h4 mb-2">System configuration</h4>
						...
						>
							...
							<h4 className="h4 mb-2">Equipments relationship</h4>
							<p className="text-lg text-gray-400 text-center">
								Duis aute irure dolor in reprehenderit in voluptate velit esse
								cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
								cupidatat.
						...
						>
							...
							<h4 className="h4 mb-2">Plant Metadata</h4>
							<p className="text-lg text-gray-400 text-center">
								Duis aute irure dolor in reprehenderit in voluptate velit esse
								cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
								cupidatat.
